...
dotnet publish MMR.UI\MMR.UI.csproj -p:VersionSuffix="$suffix" -c Release -o build --no-self-contained
dotnet publish MMR.CLI\MMR.CLI.csproj -p:VersionSuffix="$suffix" -c Release -o build --no-self-contained
md dist
